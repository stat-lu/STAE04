...
grass species [Echinochloa crus-galli](https://en.wikipedia.org/wiki/Echinochloa_crus-galli).
...
**datasets** (a package part of the base R distribution). There are five
variables:
...
The goal of the experiment was to investigate who carbon dioxide uptake
...
concentration. We'll of course put uptake on the y axis, and concentration
on the x axis. Before we get started, we'll also rename some of the

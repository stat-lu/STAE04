...
free to replace the palette with your favourite Wes Anderson movie palette.
...
The results are not convincing. There clearly appears to be some kind of
...
some of the issues with overlapping with opacity.
...
does not communicate a message effectively. To highlight the distribution
...
age variable into categories, and then plot our plot. To top it off, we 
...
not the *Metropolitan Santiago* region. An alternative could be to switch
to histograms instead.^[See 

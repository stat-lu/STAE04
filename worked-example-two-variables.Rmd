...
hardly surprising if you think about it. But kind of relationship is it?
Describing it as a linear relationship is not accurate. 

The best way to describe this relationship is as a *inverse* relationship. That
...
Here is a first attempt. We use the line geom, which usually comes quite natural
...
The result is possible not quite as nice as you'd expect. Can you figure out
...
In this case a better idea is to use the point geom,
...
<https://github.com/stat-lu/STAE04/blob/master/worked-example-two-variables.Rmd>.

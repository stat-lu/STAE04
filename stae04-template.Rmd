...
So far we've only really talked about features that are made possible by pandoc and its flavor of Markdown. But what makes R Markdown special is that is allows us to write seamlessly include chunks of R code in our texts. This is a code chunk that plots a simple plot using ggplot2:

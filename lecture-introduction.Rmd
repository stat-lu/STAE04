...
```{r, cache = TRUE, dev = "png", fig.height = 7, fig.width = 9, res = 296, pointsize =10}
library(gganimate)
...
* Data visualization: Charts, Maps, and Interactive Graphics
  `r Citep(bib, "grant2018")`. Available through LUBsearch.
* A Layered Grammar of Graphics `r Citep(bib, "wickham2010")`. Available
  online for free.
]
...
* [stackoverflow.com](https://stackoverflow.com/) (tag: ggplot2)
* R Graphics Cookbook `r Citep(bib, "chang2013")`. Abbreviated version
  available online at <http://www.cookbook-r.com/Graphs/>, but

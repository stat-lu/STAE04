...
plot pairs of variables in a grid, plotting the joint distributions of
every pair of variables

pairs plots of scatter plots (a scatter plot matrix) can be
accomplished with ggplot2 by **pivoting** and **facets**

the [GGally](https://ggobi.github.io/ggally) package `r Citep(bib, "emerson2013")`
presents a cleaner approach

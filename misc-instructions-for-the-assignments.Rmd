...
If you prefer to use a WYSIWYG, you will likely want to either 
...
included. Prefer a walk-through approach rather than question: answer format. 
...
See [The Anatomy of a Plot](https://canvas.education.lu.se/courses/5769/pages/the-anatomy-of-a-plot) for
...
complete the reviews, you need to fill out the **rubric** associated with the
...
Canvas. Please see
[this page](https://community.canvaslms.com/t5/Student-Guide/How-do-I-submit-a-peer-review-to-an-assignment/ta-p/293) to read more about peer-reviewing in canvas.
...
- Functions in the tidyverse are well-documented. Students who are successful 
  at theseassignments often make good use of the help files for the various 

...
intuitive and common: easily understood
...
```{r, fig.cap = "A stacked bar chart. Y axis unit is now proportions within each category.", fig.width = 8}
ggplot(happy, aes(degree, fill = happy)) +
...
```{r, fig.cap = "The proportional stacked bar chart with a different mapping.", fig.width = 8}
...
```{r, echo = FALSE, fig.width = 4, fig.height = 4, fig.cap = "A plot from the vcd package."}
library(vcd)

...
If you use facets in your plot (more on this later) you might have several canvasses
in a visualization.
...
When including a visualization in a report, it should always have a 
numbered caption. The caption should make the entire visualization self-explanatory.

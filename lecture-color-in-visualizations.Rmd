...
color is useful, but how do we choose colors appropriately?
...
ggplot2 cannot, howver, know when a variable should be mapped to a **diverging** palette
...
typically used for data that is ordered high-to-low
...
several different types: protanotopia, deuteranopia, protanomaly, deuteranomaly, tritanopia,
tritanomaly
]
...
.pull-left[
`scale_color_brewer()`: discrete or nominal data 
...
aesthetics change but are still important to pay attention to
